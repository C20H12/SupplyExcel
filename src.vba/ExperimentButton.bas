...
Sub NC_Experiment()
    ...
    NCInput_Form.NC_ChestInput.Value = GenerateRandomMeasurement(24, 45)
    NCInput_Form.NC_WaistInput.Value = GenerateRandomMeasurement(30, 45)
    NCInput_Form.NC_HipsInput.Value = GenerateRandomMeasurement(30, 45)
